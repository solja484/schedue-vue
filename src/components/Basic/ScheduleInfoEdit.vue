<template>
  <div v-if="!loading">
    ...
    <div class="container mx-5">
      ...
      <div class="row " v-if="schedule_type != subFacultyType">
      ...
      <div class="row " v-else-if="schedule_type == subFacultyType">
...
export default {
  ...
  mounted() {
    if (this.currentState == this.editState) {
      ...
      this.$store.dispatch(
        "edit/fetchNewScheduleData",
        this.$store.getters["schedule/createType"]
      );
    }
  }
};
