<template>
    <div>
        ...
        <div class="px-5 mt-3">
        <EmptyTable v-if="currentState==createState" :schedule_type="schedule_type" ></EmptyTable>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        name: "ScheduleInfoEmpty",
        components: {EmptyTable, Title, BFormSelect, BFormSelectOption, BFormGroup, BFormRadioGroup, BFormInput},
        data() {
            return {
                ...
                selected_season: 1,
                selected_academic_year: this.$store.getters['university'].current_year,
                notes: "",
                selected_level: 1,
